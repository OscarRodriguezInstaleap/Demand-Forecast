...
# === BLOQUE 1: Carga y limpieza de datos (soporta multi-archivo) ===
st.sidebar.header("Paso 1: Carga tus archivos CSV (puedes subir varios)")
archivos = st.sidebar.file_uploader("Selecciona uno o más archivos CSV", type=["csv"], accept_multiple_files=True)
...
if archivos:
    ...
    st.info("⬅️ Por favor carga uno o más archivos CSV para comenzar.")
